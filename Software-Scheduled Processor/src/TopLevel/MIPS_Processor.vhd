...
PC : N_bit_registerPC
	generic MAP(32)
    port MAP(iCLK, iRST, '1', s1_intoPC, x"00400000", s_NextInstAddr);
...
IFID : N_bit_registerPC
	generic MAP(64)
    port MAP(iCLK, iRST, '1', s_Inst & s1_PCPlus4, x"0000000000000000", s_IFIDout);
...
Cont: control
    port MAP(s2_Inst(31 downto 26), s2_Inst(5 downto 0), s1_StoreHalt, s1_RegDest, s1_JumpSelect, s1_JRSelect, s1_Branch, s1_LoadAmt, s1_Bne, s1_MemtoReg, s1_AluControl,
	s1_DMemWr, s1_AluSrc, s_SignExtndIm, s1_SignExtndLoad, s1_RegWr, s1_JALSelect, s1_OvfEn, s1_ShiftType); 

s1_InstSL2 <=  s2_PCPlus4(31 downto 28) & s2_Inst(25 downto 0)& b"00";


IDEXE : N_bit_registerPC
	generic MAP(213)
    port MAP(iCLK, iRST, '1', s2_Inst &
...
s_DMemData <= s_EXEMEMout(147 downto 116);
