...
s_Slt <= "0000000000000000000000000000000" &     ((i_A(31) AND (NOT s_B(31))) OR (NOT (i_A(31) XOR s_B(31)) AND s_AddSub(31)));--Our SLT value. 

-- ((sign_rs AND NOT sign_rt) OR (NOT (sign_rs XOR sign_rt) AND sign_result))
