...
-- Signals for mux outputs before bypassing
signal mux_rs_out : std_logic_vector(31 downto 0);
signal mux_rt_out : std_logic_vector(31 downto 0);
...
--Bypass Logic below
--Check if wen, id=rs(rt) and then also check to make sure not zero position. 
o_rs <= i_D when (i_wen = '1' and i_rd = i_rs and i_rd /= "00000") else mux_rs_out;
o_rt <= i_D when (i_wen = '1' and i_rd = i_rt and i_rd /= "00000") else mux_rt_out;
